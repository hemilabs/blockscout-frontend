...
const FRONT_VERSION_URL = `https://github.com/hemilabs/blockscout-frontend/tree/${ config.UI.footer.frontendVersion }`;
const FRONT_COMMIT_URL = `https://github.com/hemilabs/blockscout-frontend/commit/${ config.UI.footer.frontendCommit }`;
